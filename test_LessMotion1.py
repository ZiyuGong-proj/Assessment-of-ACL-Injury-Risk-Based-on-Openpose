...
def run_parser_plot_out():
    fig, ax = plt.subplots(num="A1：屈膝测试")
    ln, = ax.plot([], [], lw=2)
    ...
    def data_sideways():
        ...
        while 1:
            for i in OpenposeJsonParser_sideways().stream_update_point_change_data_in_the_dir_1("/home/jasonccf/openpose/examples/media_out",
                                                                    sum=True):

                p.append(Index_score.Return_index_1(i))
                print(p)
                x += 1
                yield x,i
    ...
    #    x = 0
    #    while 1:
    #        for i in OpenposeJsonParser_front().stream_update_point_change_data_in_the_dir("/home/jasonccf/openpose/examples/media_out",
    #                                                                sum=True):
    #            x += 1
    #            yield  x,i
